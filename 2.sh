...
container_id=$(docker run -d -p 5901:5901 -v $(pwd):/mnt/test quay.io/consideratio/test:turbo websockify --verbose --log-file=/tmp/websockify.log --heartbeat=30 localhost:5901 -- python /mnt/test/dummy-tcp-server.py)
sleep 3
